...
def main():
    csv_path = Path("outputs/cifar10_epoch_results_multi_accountants.csv")
    ...
    out_path_eps = save_dir / "cifar10_epsilon_vs_epoch_styled.png"
    ...
    out_path_acc = save_dir / "cifar10_accuracy_vs_epoch_styled.png"
