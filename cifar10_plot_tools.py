...
# 基本配置
# =========================
CSV_FILE = "outputs/cifar10_epoch_results_multi_accountants_2026-04-15_00-24-45.csv"
SAVE_DIR = os.path.dirname(CSV_FILE)
...
plt.tight_layout()
plt.savefig(
    os.path.join(SAVE_DIR, "cifar10_test_accuracy_plot.png"),
    dpi=300,
    bbox_inches="tight"
)
plt.show()
...
plt.tight_layout()
plt.savefig(
    os.path.join(SAVE_DIR, "cifar10_training_accuracy_plot.png"),
    dpi=300,
    bbox_inches="tight"
)
plt.show()